...
const Rectangle rectangles[N_RECTANGLES] = Rectangle[](Rectangle(vec3(0, 0, 0), vec3(0, 0, 1), vec2(0.5, 0.5), Transform(mat4(20, 0, 0, 0, 0, 2.53518e-05, -20, 0, 0, 1, 1.26759e-06, 0, 0, -2.5, 0, 1), mat4(0.05, 0, 0, 0, 0, 6.33795e-08, 1, 0, 0, -0.05, 1.26759e-06, 0, 0, 1.58449e-07, 2.5, 1), mat3(0.05, 0, 0, 0, 6.33795e-08, -0.05, 0, 1, 1.26759e-06), vec3(20, 20, 1)), 0, Material(vec3(0.85, 0.81, 0.78), 0, -1, 1, -1, -1, -1))
);
const Sphere spheres[N_SPHERES] = Sphere[](Sphere(vec3(0, 0, 0), 1, Transform(mat4(3, 0, 0, 0, 0, 3, 0, 0, 0, 0, 3, 0, 0, 1.25, 0, 1), mat4(0.333333, 0, 0, 0, 0, 0.333333, 0, 0, 0, 0, 0.333333, 0, 0, -0.416667, 0, 1), mat3(0.333333, 0, 0, 0, 0.333333, 0, 0, 0, 0.333333), vec3(3, 3, 3)), 1, Material(vec3(0.9, 0.9, 1), 0, 1.55, 4, -1, -1, -1))
);
